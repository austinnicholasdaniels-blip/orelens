...
export default function PromoBar() {
  ...
  return (
    <a href="/training"
       className="block sticky top-0 z-[60] promo-shimmer border-b border-assay/40 relative overflow-hidden"
       style={{ backgroundImage: "linear-gradient(180deg,#FFFFFF 0%,#E9EFF9 100%)" }}>
